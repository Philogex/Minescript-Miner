    ...
    def setUpClass(cls):
        ...
        subprocess.run(
            [
                ...
                str(cls.project_root / "native/src/aim/angle.cpp"),
                str(cls.project_root / "native/src/geometry/clipping.cpp"),
                str(cls.project_root / "native/src/geometry/constraint_region.cpp"),
                str(cls.project_root / "native/src/scanner/branch_bound.cpp"),
                str(cls.project_root / "native/src/geometry/geometry.cpp"),
                str(cls.project_root / "native/src/catalog/geometry_catalog.cpp"),
                str(cls.project_root / "native/src/geometry/geometry_store.cpp"),
                str(cls.project_root / "native/src/scanner/projection.cpp"),
                str(cls.project_root / "native/src/scanner/scan_region.cpp"),
                str(cls.project_root / "native/src/scanner/target_solver.cpp"),
                str(cls.project_root / "native/src/scanner/view_projection.cpp"),
                str(cls.project_root / "native/src/scanner/reach_projection.cpp"),
                "-o",
                str(cls.executable),
            ],
            check=True,
